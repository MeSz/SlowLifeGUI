...
public class MainPanel extends JPanel {
    ...
    /**
     * Optimized version. Set to public for JUnit testing.
     ...
     * @return 
     */
    public int convertToInt_OLD(int x) {
        int c = 0;
        String padding = "0";
        while (c < _r) {
    ...
    /**
     * This is for debug use. It will display the state of cells in a convenient format. First it will display backup
     * cells and then the current cells. Backup cells are what you revert to when you press Undo.
     */
